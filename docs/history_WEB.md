...
| Versión | Tipo | Cambio |
|:---:|:---:|---|
| **3.1.12** 🧪 | ✨ | **BETA (en prueba).** En la sección **Pantalla** se puede **habilitar/deshabilitar el "reset con el botón"** y ajustar el **tiempo de mantener** (1 a 5 s). Requiere firmware 3.1.6+. |
